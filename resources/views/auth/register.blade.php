                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('gender') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-1">
                                    <input id="gender" type="radio" class="form-control" name="gender" value='Male' required>
                            ...
                            <div class="col-md-1">
                                <input id="gender" type="radio" class="form-control" name="gender" value='Female' required>
                            </div>
                        </div>
                        ...
                        <div class="form-group{{ $errors->has('dob') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="dob" placeholder="yy-mm-dd" type="text" class="form-control" name="dob" value="{{ old('dob') }}" required>
